...
const topLevelDivStyling =
    "flex flex-col w-0 sm:w-24 max-w-max h-auto min-h-screen bg-one-dark-gutterGrey shadow-xl invisible sm:visible float-left";
const logoDivStyling = "flex rounded-full bg-rocket-blue-700 m-2 px-4 py-4 cursor-pointer";
